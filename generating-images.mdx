...
![Image generating pag](/images/image-generation.jpg)
...
<CardGroup cols={2}>
  <Card title="Flynn's AI Models" icon="image" href="/flynns-ai-models">
    Learn more about Flynn's AI models and their differences
  </Card>

  <Card title="Create you own AI model" icon="layer-group" href="/training-custom-models">
    Train your own AI model to get the look you want!
  </Card>
</CardGroup>
...
* Need help crafting prompts? Check out the [Creating Prompts](/creating-prompts) card for tips and examples.
...
Once a image is generated they will be saved automatically to your image library, found in the [My Images](/image-library) sections. 

#### Credits

With Flynn's AI, One image generated cost 1 image credit. see our [Credits](/credits-system) page for more details.
